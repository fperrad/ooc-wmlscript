...
wmls_is(<<'CODE', <<'OUT', 'String.length');
...
wmls_is(<<'CODE', <<'OUT', 'String.isEmpty');
extern function main()
{
    var a = "Hello";
    var b = "";
...
wmls_is(<<'CODE', <<'OUT', 'String.charAt');
extern function main()
{
...
wmls_is(<<'CODE', <<'OUT', 'String.subString');
extern function main()
{
    var a = "ABCD";
...
wmls_is(<<'CODE', <<'OUT', 'String.replace', todo => 'not yet');
extern function main()
{
...
wmls_is(<<'CODE', <<'OUT', 'String.elements', todo => 'not yet');
extern function main()
{
...
wmls_is(<<'CODE', <<'OUT', 'String.elementAt', todo => 'not yet');
extern function main()
{
    var a = "My name is Joe; Age 50;";
...
wmls_is(<<'CODE', <<'OUT', 'String.removeAt', todo => 'not yet');
extern function main()
{
    var a = "A A; B C D";
    var s = " ";
...
wmls_is(<<'CODE', <<'OUT', 'String.replaceAt', todo => 'not yet');
extern function main()
{
    var a = "B C; E";
    var s = " ";
...
wmls_is(<<'CODE', <<'OUT', 'String.insertAt', todo => 'not yet');
extern function main()
{
    var a = "B C; E";
    var s = " ";
...
wmls_is(<<'CODE', <<'OUT', 'String.squeeze', todo => 'not yet');
extern function main()
{
    var a = "Hello";
    var b = " Bye   Jon . \r\n See you!  ";
...
wmls_is(<<'CODE', <<'OUT', 'String.compare');
extern function main()
{
    var a = "Hello";
    var b = "Hello";
...
wmls_is(<<'CODE', <<'OUT', 'String.format', cflags => '-On', todo => 'not yet');
extern function main()
{
    var a = 45;
    var b = -45;
